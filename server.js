...
// Konfigurasi Unblocker Proxy Engine
...
app.get('/', (req, res) => {
    ...
    <body>
        <div class="container">
            ...
            <div class="footer">Developed by KKnar • Hosted on Render</div>
        </div>
...
app.listen(PORT, () => {
    ...
    <body>
        <div class="container">
            ...
            <div class="footer">Developed by NarzX • Vercel Hosted</div>
        </div>
...
// Wajib untuk Vercel (Jangan diubah)
module.exports = app;
               .container {
                   text-align: center;
                   background: #161b22;
